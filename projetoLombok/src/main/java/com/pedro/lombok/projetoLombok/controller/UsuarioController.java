package com.pedro.lombok.projetoLombok.controller;
...
import com.pedro.lombok.projetoLombok.services.UsuarioService;
...
public class UsuarioController {
	...
	@PostMapping
	@Operation(summary = "Cadastro um usuario")
	...
	@DeleteMapping("/id")
	@Operation(summary = "Exclui o usuario")
